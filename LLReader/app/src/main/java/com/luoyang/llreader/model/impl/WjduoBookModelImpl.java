...
import com.luoyang.llreader.model.IWjduoBookModel;
 ...
 * 分类库
 */
public class WjduoBookModelImpl extends BaseModelImpl implements IWjduoBookModel {

    /** 2020.5.7 网站http://www.kushuge.com 改成了 https://www.kushuge.com */
    /** 网站http://www.wjduo.com 改成了 http://www.kushuge.com */
    //public static final String  TAG = "http://www.wjduo.com";
    //  public static final String  TAG = "http://www.kushuge.com";
    //public static final String  TAG = "https://www.dushuge.net/";
    public static final String  TAG = "https://www.ranwen.com/";


    public static WjduoBookModelImpl getInstance(){
        return new WjduoBookModelImpl();
    }

    /**
     * 获取分类库信息
     *
     * http://www.wjduo.com/xuanhuan/
     */

//
//    @Override
//    public Observable<List<SearchBookBean>> getKindLibraryData() {
//        return getRetrofitObject("http://www.wjduo.com/xuanhuan/").create(WjduoApi.class).getLibraryData("").flatMap(new Function<String, ObservableSource<List<SearchBookBean>>>() {
//            @Override
...
//        Log.d(Common.TAG,TAG+" Book" + s );
                ...
                try{
                    ...
                    if (null != booksE && booksE.size() >=1){
                        ...
                        for (int i = 0; i < booksE.size(); i++) {
                            ...
                            item.setKind(booksEP10.getElementsByClass("bookinfo").get(0).getElementsByClass("cat")
                                    .get(0).text());
                            item.setAuthor(booksEP10.getElementsByClass("bookinfo").get(0).getElementsByClass("author")
                                    .get(0).text());
    ...
    private BookInfoBean analyBookinfo(String s, String novelUrl) {
        ...
        bookInfoBean.setOrigin("wjduo.com");
        return bookInfoBean;
    }
    ...
    public void getChapterList(final BookShelfBean bookShelfBean, final OnGetChapterListListener getChapterListListener) {
        getRetrofitObject(TAG).create(WjduoApi.class).getChapterList(bookShelfBean.getBookInfoBean().getChapterUrl().replace(TAG, "")).flatMap(new Function<String, ObservableSource<WebChapterBean<BookShelfBean>>>() {
            @Override
