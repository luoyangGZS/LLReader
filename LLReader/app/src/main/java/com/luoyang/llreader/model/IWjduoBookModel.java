 ...
 * on 2018/11/12
 */
public interface IWjduoBookModel extends IStationBookModel {
    Observable<List<SearchBookBean>> getKindBook(String url, int page);

    /**
     * 获取主页信息
     */
    Observable<List<SearchBookBean>> getkindLibraryBooks(String s);

    /**
     * 解析主页数据
     */
//    Observable<List<SearchBookBean>> getKindLibraryData();
}
