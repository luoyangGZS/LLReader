...
import com.luoyang.llreader.common.api.IGxwztvApi;
import com.luoyang.llreader.listener.OnGetChapterListListener;
import com.luoyang.llreader.model.IGxwztvBookModel;
...
public class GxwztvBookModelImpl extends BaseModelImpl implements IGxwztvBookModel     {
    ...
    public Observable<List<SearchBookBean>> searchBook(String content, int page) {
        ...
        return getRetrofitObject(TAG).create(IGxwztvApi.class).searchBook(content).flatMap(new Function<String, ObservableSource<List<SearchBookBean>>>() {
            @Override
